# 9-3-2-reactive-messaging-with-processor
...
You can then execute your native executable with: `./target/9-3-2-reactive-messaging-with-processor-1.0.0-SNAPSHOT-runner`
